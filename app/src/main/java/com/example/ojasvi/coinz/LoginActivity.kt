 ...
 */
class LoginActivity : AppCompatActivity(), View.OnClickListener, LoaderCallbacks<Cursor> {
    /**
     * Keep track of the login task to ensure we can cancel it if requested.
     */
    private var mStatusTextView: TextView? = null
    private var mDetailTestView: TextView? = null
...
//        mDetailTestView = findViewById(R.id.detail)
